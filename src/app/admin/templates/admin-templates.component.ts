...
const DEFAULT_TEMPLATES: Omit<EmailTemplate, 'id'>[] = [
  ...
  },
  {
    ...
    from_name: 'Livwell', from_email: 'onboarding@resend.dev', enabled: true,
    variables: ['name', 'property_title', 'agent_name', 'agent_phone'],
    body: `<!DOCTYPE html><html><head><meta charset="utf-8"></head><body style="margin:0;padding:0;background:#f0f0f0;font-family:'Segoe UI',Arial,sans-serif"><div style="max-width:600px;margin:0 auto;padding:24px 0"><div style="background-color:#1a5c3a;border-radius:16px 16px 0 0;padding:40px 40px 32px;text-align:center"><img src="https://livwelldubai.ae/images/livwell%20fav%20logo.png" alt="Livwell" width="90" height="90" style="width:90px;height:90px;border-radius:50%;background-color:#fff;padding:6px;display:inline-block;margin-bottom:14px" /><div style="color:#fff;font-size:26px;font-weight:700;margin-bottom:4px">Livwell</div></div><div style="background-color:#fff;padding:36px 40px 32px"><div style="display:inline-block;background-color:#dcfce7;color:#15803d;font-size:12px;font-weight:700;padding:4px 12px;border-radius:20px;letter-spacing:0.5px;text-transform:uppercase;margin-bottom:16px">Enquiry Received</div><h2 style="margin:0 0 10px;font-size:22px;color:#111;font-weight:700">Thank you, {{name}}!</h2><p style="color:#4b5563;font-size:15px;line-height:1.7;margin:0 0 24px">We have received your commercial property enquiry for <strong style="color:#111">{{property_title}}</strong>. Our commercial specialist will review your request and get in touch with you shortly.</p><div style="background-color:#f9fafb;border:1px solid #e5e7eb;border-radius:12px;padding:20px;margin-bottom:24px"><div style="font-size:11px;font-weight:700;color:#9ca3af;letter-spacing:1px;text-transform:uppercase;margin-bottom:12px">Your Commercial Specialist</div><div style="display:flex;align-items:center;gap:14px"><div style="width:48px;height:48px;border-radius:50%;background-color:#1a5c3a;color:#fff;font-size:20px;font-weight:700;text-align:center;line-height:48px;flex-shrink:0">A</div><div><div style="font-size:16px;font-weight:700;color:#111;margin-bottom:4px">{{agent_name}}</div><div style="font-size:13px;color:#1a5c3a;font-weight:600">📞 {{agent_phone}}</div></div></div></div><div style="text-align:center;margin:28px 0"><a href="https://livwelldubai.ae/commercial-properties" style="display:inline-block;padding:14px 40px;background-color:#1a5c3a;color:#fff;text-decoration:none;border-radius:50px;font-weight:700;font-size:16px">Browse More Commercial →</a></div></div><div style="background-color:#1a5c3a;border-radius:0 0 16px 16px;padding:24px 40px;text-align:center"><img src="https://livwelldubai.ae/images/livwell%20fav%20logo.png" alt="Livwell" width="48" height="48" style="width:48px;height:48px;border-radius:50%;background-color:#fff;padding:3px;display:inline-block;margin-bottom:8px" /><div style="color:rgba(255,255,255,0.85);font-size:15px;font-weight:700;margin-bottom:6px">Livwell</div><div style="color:rgba(255,255,255,0.5);font-size:12px;line-height:1.8">Livwell Real Estate LLC &nbsp;·&nbsp; Dubai, UAE<br><a href="https://livwelldubai.ae/" style="color:rgba(255,255,255,0.65);text-decoration:none">livwelldubai.ae</a> &nbsp;·&nbsp; © 2026</div></div></div></body></html>`,
  },
  {
    key: 'newsletter_welcome',
    label: 'Newsletter Welcome',
    description: 'Sent to a visitor when they subscribe to the newsletter.',
    subject: 'Welcome to the Livwell Newsletter! 🏡',
    from_name: 'Livwell', from_email: 'onboarding@resend.dev', enabled: true,
    variables: ['email'],
    body: `<!DOCTYPE html><html><head><meta charset="utf-8"></head><body style="margin:0;padding:0;background:#f0f0f0;font-family:'Segoe UI',Arial,sans-serif"><div style="max-width:600px;margin:0 auto;padding:24px 0"><div style="background-color:#1a5c3a;border-radius:16px 16px 0 0;padding:40px 40px 32px;text-align:center"><img src="https://livwelldubai.ae/images/livwell%20fav%20logo.png" alt="Livwell" width="90" height="90" style="width:90px;height:90px;border-radius:50%;background-color:#fff;padding:6px;display:inline-block;margin-bottom:14px" /></div><div style="background-color:#226b47;padding:28px 40px 32px;text-align:center"><h1 style="color:#fff;font-size:26px;font-weight:800;margin:0 0 10px;line-height:1.3">You're subscribed! 🎉</h1><p style="color:rgba(255,255,255,0.85);font-size:15px;line-height:1.65;margin:0">Weekly property insights, new listings &amp; investment tips — delivered to your inbox.</p></div><div style="background-color:#fff;padding:36px 40px 32px"><p style="color:#374151;font-size:15px;line-height:1.75;margin:0 0 24px">Hi there! Thank you for subscribing to the <strong>Livwell Weekly Newsletter</strong>. You will now receive exclusive market reports, new listings, investment tips, and UAE real estate news every week.</p><div style="background-color:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:22px 24px;margin-bottom:24px"><div style="font-size:11px;font-weight:700;color:#166534;letter-spacing:1px;text-transform:uppercase;margin-bottom:16px">What to expect each week</div><table width="100%" cellpadding="0" cellspacing="0"><tr><td style="padding:8px 0;font-size:14px;color:#374151">📈&nbsp; <strong>Weekly market reports</strong> — Dubai real estate trends</td></tr><tr><td style="padding:8px 0;font-size:14px;color:#374151">🏠&nbsp; <strong>New listings first</strong> — exclusive previews before they go public</td></tr><tr><td style="padding:8px 0;font-size:14px;color:#374151">💡&nbsp; <strong>Investment tips</strong> — expert insight on where to buy</td></tr><tr><td style="padding:8px 0;font-size:14px;color:#374151">🔔&nbsp; <strong>Price drop alerts</strong> — get notified when prices change</td></tr></table></div><div style="text-align:center;margin:28px 0 20px"><a href="https://livwelldubai.ae/" style="display:inline-block;padding:14px 44px;background-color:#1a5c3a;color:#fff;text-decoration:none;border-radius:50px;font-weight:700;font-size:16px">Explore Properties →</a></div><p style="color:#9ca3af;font-size:12px;text-align:center;margin:0">You subscribed with <strong>{{email}}</strong>. To unsubscribe at any time, reply "Unsubscribe" to this email.</p></div><div style="background-color:#1a5c3a;border-radius:0 0 16px 16px;padding:28px 40px;text-align:center"><img src="https://livwelldubai.ae/images/livwell%20fav%20logo.png" alt="Livwell" width="48" height="48" style="width:48px;height:48px;border-radius:50%;background-color:#fff;padding:3px;display:inline-block;margin-bottom:8px" /><div style="color:rgba(255,255,255,0.85);font-size:15px;font-weight:700;margin-bottom:6px">Livwell</div><div style="color:rgba(255,255,255,0.5);font-size:12px;line-height:1.8">Livwell Real Estate LLC &nbsp;·&nbsp; Dubai, UAE<br><a href="https://livwelldubai.ae/" style="color:rgba(255,255,255,0.65);text-decoration:none">livwelldubai.ae</a> &nbsp;·&nbsp; © 2026</div></div></div></body></html>`,
  },
  {
    key: 'newsletter_notify_admin',
    label: 'Newsletter New Subscriber (Admin)',
    description: 'Sent to admin when someone subscribes to the newsletter.',
    subject: 'New Newsletter Subscriber — {{email}}',
    from_name: 'Livwell Website', from_email: 'onboarding@resend.dev', enabled: true,
    variables: ['email', 'subscribed_at'],
    body: `<!DOCTYPE html><html><head><meta charset="utf-8"></head><body style="margin:0;padding:0;background:#f0f0f0;font-family:'Segoe UI',Arial,sans-serif"><div style="max-width:600px;margin:0 auto;padding:24px 0"><div style="background-color:#1a5c3a;border-radius:16px 16px 0 0;padding:32px 40px;text-align:center"><img src="https://livwelldubai.ae/images/livwell%20fav%20logo.png" alt="Livwell" width="70" height="70" style="width:70px;height:70px;border-radius:50%;background-color:#fff;padding:5px;display:inline-block;margin-bottom:10px" /></div><div style="background-color:#fff;padding:36px 40px 32px"><div style="display:inline-block;background-color:#dcfce7;color:#15803d;font-size:12px;font-weight:700;padding:4px 12px;border-radius:20px;letter-spacing:0.5px;text-transform:uppercase;margin-bottom:16px">New Subscriber</div><h2 style="margin:0 0 16px;font-size:22px;color:#111;font-weight:700">Someone just subscribed to your newsletter</h2><div style="background-color:#f9fafb;border:1px solid #e5e7eb;border-radius:12px;padding:22px 24px;margin-bottom:24px"><table width="100%" cellpadding="0" cellspacing="0"><tr><td style="padding:9px 0;font-size:13px;color:#6b7280;width:130px">Email</td><td style="padding:9px 0;font-size:14px;font-weight:700;color:#111">{{email}}</td></tr><tr><td style="padding:9px 0;font-size:13px;color:#6b7280;border-top:1px solid #f3f4f6">Subscribed at</td><td style="padding:9px 0;font-size:14px;color:#111;border-top:1px solid #f3f4f6">{{subscribed_at}}</td></tr></table></div><div style="text-align:center"><a href="https://livwelldubai.ae/admin/newsletter" style="display:inline-block;padding:12px 36px;background-color:#1a5c3a;color:#fff;text-decoration:none;border-radius:50px;font-weight:700;font-size:15px">View Subscribers →</a></div></div><div style="background-color:#1a5c3a;border-radius:0 0 16px 16px;padding:24px 40px;text-align:center"><div style="color:rgba(255,255,255,0.5);font-size:12px">Livwell Real Estate LLC &nbsp;·&nbsp; Dubai, UAE &nbsp;·&nbsp; © 2026</div></div></div></body></html>`,
  },
  {
...
export class AdminTemplatesComponent implements OnInit {
  ...
  async sendTest(): Promise<void> {
    ...
    const dummyData: Record<string, string> = {
      ...
      reset_url:      'https://livwelldubai.ae/reset-password?token=TEST',
      portal_url:     'https://livwelldubai.ae/agent/login',
  ...
  get previewHtml(): string {
    ...
    const dummy: Record<string, string> = {
      ...
      reset_url: '#', portal_url: 'https://livwelldubai.ae/agent/login', password: 'TempPass@123',
    };
