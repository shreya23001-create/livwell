...
export const routes: Routes = [
  // ── Public website ──────────────────────────────────────
  {
    ...
    children: [
      ...
      { path: 'guides', pathMatch: 'full', loadComponent: () => import('./public/blog/blog.component').then(m => m.BlogComponent) },
      { path: 'guides/:slug', loadComponent: () => import('./public/guide-detail/guide-detail.component').then(m => m.GuideDetailComponent) },
      ...
      { path: 'branded-residence/:id', loadComponent: () => import('./public/branded-residence-detail/branded-residence-detail.component').then(m => m.BrandedResidenceDetailComponent) },
      ...
      { path: 'news/:slug', loadComponent: () => import('./public/news-detail/news-detail.component').then(m => m.NewsDetailComponent) },
    ...
    children: [
      ...
      // Protected admin shell
      {
        ...
        children: [
          ...
          { path: 'leads/:id', loadComponent: () => import('./admin/lead-profile/admin-lead-profile.component').then(m => m.AdminLeadProfileComponent) },
          ...
          { path: 'blogs', loadComponent: () => import('./admin/blogs/admin-blogs.component').then(m => m.AdminBlogsComponent) },
          { path: 'news', loadComponent: () => import('./admin/blogs/admin-blogs.component').then(m => m.AdminBlogsComponent) },
          ...
          { path: 'faqs', loadComponent: () => import('./admin/faqs/admin-faqs.component').then(m => m.AdminFaqsComponent) },
    ...
    children: [
      ...
      // Protected agent shell
      {
        ...
        children: [
          ...
          { path: 'leads/:id/followups', loadComponent: () => import('./agent/lead-followups/lead-followups.component').then(m => m.LeadFollowupsComponent) },
