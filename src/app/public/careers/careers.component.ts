...
export class CareersComponent {
  ...
  readonly jobs: Job[] = [
    { id: 1, title: 'Commercial Expert', type: 'Full Time', location: 'Dubai, UAE', tag: 'Sales' },
    { id: 2, title: 'Commercial Expert (Sales)', type: 'Full Time', location: 'Dubai, UAE', tag: 'Sales' },
    { id: 3, title: 'Property Advisor (Agent Sales)', type: 'Full Time', location: 'Dubai, UAE', tag: 'Advisory' },
    { id: 4, title: 'Property Advisor – Off Plan (Sales)', type: 'Full Time', location: 'Dubai, UAE', tag: 'Off-Plan' },
    { id: 5, title: 'Sales & Leasing Consultant (Sales)', type: 'Full Time', location: 'Dubai, UAE', tag: 'Leasing' },
    { id: 6, title: 'Senior Property Consultant', type: 'Full Time', location: 'Dubai, UAE', tag: 'Senior' },
  ];
  ...
  applyNow(id: number) {
    this.applyJobId.set(id);
    setTimeout(() => window.open('mailto:careers@livwelldubai.com?subject=Application for ' + this.jobs.find(j => j.id === id)?.title, '_blank'));
  }
}
