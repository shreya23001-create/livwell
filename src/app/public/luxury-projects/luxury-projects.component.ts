...
export class LuxuryProjectsComponent implements OnInit {
  ...
  // â”€â”€ Search / filter state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  searchQuery    = signal('');
  filterType     = signal('');
  filterBeds     = signal('');
  ...
  // â”€â”€ Dropdown open states â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  private async loadProjects() {
    ...
    let query = this.sb.from('projects').select('*').eq('status', 'Published');
  ...
  onDocClick(e: Event) {
    ...
    if (!target.closest('.lxp-filter-bar')) this.closeAllDrops();
  }
