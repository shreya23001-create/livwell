...
const ALL_PROJECTS: OffPlanProject[] = [
  {
    ...
    beds: 'Studio â€“ 3 Beds', description: 'Iconic architecture meets smart living in this striking development at Al Jaddaf. Binghatti Zenith redefines urban living with its bold geometric facade and premium interiors. Each residence is crafted to maximise natural light and offer sweeping city views.\n\nResidents enjoy a curated collection of amenities including rooftop pools, state-of-the-art fitness centres, and 24/7 concierge service. Located minutes from the Dubai Metro, Ras Al Khor Wildlife Sanctuary, and Downtown Dubai, Zenith offers both urban connectivity and natural serenity.',
  ...
  },
  {
    ...
    beds: '1â€“3 Beds', description: 'Grand Bleu Tower at Emaar Beachfront is an exclusive waterfront development designed by fashion icon Elie Saab. Set on a private beach island between Palm Jumeirah and Dubai Marina, every residence commands unobstructed sea and skyline views.\n\nResidents enjoy private beach access, resort-style amenities, and the refined aesthetic of Elie Saab interiors â€” making this one of the most sought-after addresses in Dubai.',
  ...
  },
  {
    ...
    beds: '3â€“6 Beds', description: 'Dubai Hills Estate Villas offer expansive family living within Emaar\'s flagship master community. Surrounded by an 18-hole championship golf course, lush parks, and tree-lined boulevards, these villas combine prestige with a genuine neighbourhood lifestyle.\n\nWith easy access to Dubai Hills Mall, top schools, and major highways, this is one of Dubai\'s most family-friendly communities.',
  ...
  },
  {
    ...
    beds: 'Studioâ€“3 Beds', description: 'Creek Waters 2 is a striking residential tower at Dubai Creek Harbour, offering panoramic views of the creek, the upcoming Creek Tower, and the Dubai skyline.\n\nPart of Emaar\'s visionary waterfront city, residents benefit from a vibrant promenade, cultural destinations, and seamless connectivity to Downtown Dubai.',
    amenities: ['Creek View', 'Pool', 'Gym', 'Promenade', 'Kids Club', 'Retail', 'Parking', 'Security'],
  },
  {
    id: 17, slug: 'golf-links-emaar-south', title: 'Golf Links â€” Emaar South', developer: 'Emaar Properties', location: 'Dubai South', community: 'Dubai South',
    ...
    beds: '3â€“4 Beds', description: 'Golf Links at Emaar South is a collection of elegant townhouses overlooking a world-class 18-hole golf course near Al Maktoum International Airport.\n\nDesigned for families who appreciate green space and tranquility, Golf Links offers generous layouts, private gardens, and a complete community lifestyle with parks, retail, and leisure facilities.',
    amenities: ['Golf Course', 'Pool', 'Garden', 'Kids Play Area', 'Cycling Track', 'Retail', 'Parking', 'Security'],
  },
  {
    id: 18, slug: 'savanna-dubai-hills', title: 'Savanna â€” Dubai Hills', developer: 'Emaar Properties', location: 'Dubai Hills Estate', community: 'Dubai Hills Estate',
  ...
  },
  {
    ...
    beds: '1â€“4 Beds', description: 'Cavalli Tower is a landmark ultra-luxury skyscraper rising above Dubai Marina, designed in collaboration with the iconic Roberto Cavalli fashion house.\n\nEvery detail reflects the Cavalli signature â€” bold design, rich textures, and unapologetic glamour. Residents enjoy an exclusive beach club, private marina access, and a lifestyle that is truly one-of-a-kind.',
  ...
  },
  {
    ...
    beds: '1â€“3 Beds', description: 'Safa One is a stunning twin-tower development by DAMAC on Sheikh Zayed Road, featuring a sky rainforest, a tropical beach on the 49th floor, and unrivalled views of Safa Park and the Dubai skyline.\n\nA collaboration with de Grisogono, the world-renowned Swiss jewellery house, Safa One elevates residential living to an art form.',
    amenities: ['Sky Rainforest', 'Tropical Beach', 'Infinity Pool', 'Gym', 'Concierge', 'Retail', 'Parking', 'Security'],
  },

  // â”€â”€ Nakheel developer page projects â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  {
    ...
    beds: '2â€“5 Beds', description: 'Como Residences is an extraordinary ultra-luxury residential tower on Palm Jumeirah, offering just 76 residences with sweeping panoramic views of the Arabian Gulf, Dubai Marina, and the iconic Palm.\n\nEach residence features private pools, expansive terraces, and interiors by world-renowned designers â€” setting a new standard for ultra-luxury living in Dubai.',
  ...
  },
  {
    ...
    beds: '4â€“7 Beds', description: 'Palm Jebel Ali Villas mark the revival of Dubai\'s second palm island â€” a project bigger than Palm Jumeirah. These exclusive beachfront villas offer private beaches, direct sea access, and an extraordinary island lifestyle.\n\nWith Dubai\'s expanding south corridor and proximity to Al Maktoum International Airport, Palm Jebel Ali represents a once-in-a-generation investment opportunity.',
  ...
  },
  {
    ...
    beds: '1â€“3 Beds', description: 'Deira Islands Beach Residences offer waterfront apartments on Nakheel\'s newest island development in Deira, combining the charm of old Dubai with modern beachfront living.\n\nResidents enjoy direct beach access, a vibrant retail promenade, and easy connectivity to the historic Deira district and Dubai International Airport.',
...
export class OffPlanDetailComponent implements OnInit {
  ...
  readonly offices = [
    { name: 'HQ â€“ Business Bay', address: 'Bay Square Building 1, Business Bay' },
    { name: 'Br â€“ Palm Jumeirah', address: 'Shoreline Apartments, Palm Jumeirah' },
    { name: 'Br â€“ Dubai Marina', address: 'Marina Walk, Dubai Marina' },
    { name: 'Br â€“ JVC', address: 'Circle Mall, Jumeirah Village Circle' },
    { name: 'Br â€“ Downtown', address: 'Burj Views Podium, Downtown Dubai' },
    { name: 'Br â€“ Dubai Hills', address: 'Hills Business Park, Dubai Hills' },
    { name: 'Br â€“ Deira', address: 'Al Rigga Road, Deira' },
    { name: 'Br â€“ Al Barsha', address: 'Al Barsha 1, Sheikh Zayed Road' },
    { name: 'Br â€“ DIFC', address: 'Gate Village, DIFC' },
    { name: 'Br â€“ Mirdif', address: 'Mirdif City Centre, Mirdif' },
  ];

  faqs: FaqItem[] = [
    { question: 'What is the payment plan for this project?', answer: 'The standard plan is 10% on booking, 50% during construction in instalments, and 40% on handover. Flexible post-handover plans may also be available â€” contact our team for details.', open: false },
    ...
    { question: 'What are the service charges after handover?', answer: 'Service charges vary by development, typically AED 12â€“25 per sqft per annum. The exact rate is registered with RERA and disclosed before signing the SPA.', open: false },
